...
void SilverKey_Take(CommandContext context, GameState* gameState, WorldData* worldData)
{
...
void SilverKey_Use(CommandContext context, GameState* gameState, WorldData* worldData)
{
	...
	if (GameFlags_IsInList(gameState->gameFlags, "SilverDoorOpened"))
	{
	...
	else
	{
		...
		gameState->gameFlags = GameFlags_Add(gameState->gameFlags, "SilverDoorOpened");
	}
}


/* Build a "brick" object */
Item* SilverKey_Build()
{
	/* Create a "brick" item, using the functions defined in this file */
	return Item_Create("silver key", "A small rusted and corroded key.", true, SilverKey_Use, SilverKey_Take, NULL);
}